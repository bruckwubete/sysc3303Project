package iteration_3.intermediate_host;
...
public class IntermediateHost {
	...
	public IntermediateHost(int optionSelected, String packetType, int numberOfPacket){
		try {
...
//		                }
    ...
    private static void printMenu() {
	    ...
	    System.out.println("Command Format: (quiet/verbose) (0..4)[default to 0] (rq/data/ack) (packetNumber)");
    }
    ...
    public static void main(String args[]){
    	    ...
    	    if(input != null){
    	        ...
    	        if(parameters.length == 1){
    	            ...
    	            if (!userInputRunType.toLowerCase().equals("quiet") && !userInputRunType.toLowerCase().equals("verbose")) {
      	                ...
      	                System.out.println("For options 1..4, please specify packet type and packet number");
      	            } else if (optionSelected == 0) {
    	            ...
    	            System.out.println("Invalid command. Please follow the format: (quiet/verbose) (0..4)[default to 0] (rq/data/ack) (packetNumber)");
    	        }
    	    }
	    }
    	...
    	if(userInputRunType != null){
	        ...
	        IntermediateHost intermediateHost= new IntermediateHost(optionSelected, packetType, numberOfPacket);
