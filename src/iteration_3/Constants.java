...
public class Constants {
    ...
    public static String currentIteration = "iteration_3";
...
//            return System.getProperty("user.dir").toString() + "/" + Constants.currentIteration + "/server/";
//        }
//        return "";
//    }
  public static String getServerPath(){
...
//            return "\\src\\" + Constants.currentIteration + "\\client\\";
//        } else if (Helper.getOS().contains("linux")){
//            return System.getProperty("user.dir").toString() + "/" + Constants.currentIteration + "/client/";
//        }
//        return "";
//    }
}
